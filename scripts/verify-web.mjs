...
const flow=create+'\n'+entitlements;
for(const marker of ['ivModeCreate','ivModeStudio','Unlock with Pro','Get Pro — $40','Maybe later','Aim lead peaks around','Delivery note','Included in Basic $20','Preview, then Keep','Tour complete — open Studio for advanced.','Open advanced settings','Export stems','AI Beat-Lock','Vocal isolation'])if(!flow.includes(marker))throw Error('Create flow missing '+marker);
