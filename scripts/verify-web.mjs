...
const flow=create+'\n'+entitlements;
for(const marker of ['ivModeCreate','ivModeStudio','Unlock Pro','needs Pro','Maybe later','Try Basic free for 7 days','Try Pro free for 7 days','Subscribe Basic $20/mo','Subscribe Pro $40/mo','Current plan','Included','basicTrialUsedAt','proTrialUsedAt','Trial ends','44.1 kHz · 16-bit','48 kHz · 24-bit','Open full Studio','Aim lead peaks around','Delivery note','Included in Basic $20','Preview, then Keep','Tour complete — open Studio for advanced.','Open advanced settings','Export stems','AI Beat-Lock','Vocal isolation','Prepare','Get the apps','/get'])if(!flow.includes(marker))throw Error('Create flow missing '+marker);
